...
export async function play(lucid: LucidEvolution, gameData: GameData): Promise<TestData> {
   ...
   * Use a way to mint more of some tokens and use them to artificially increase your balance and eventually drain the entire bank.
   */
  ...
  /**
   * HINT Base64: WW91IGNhbiBtaW50IG9uZSBtb3JlIGFjY291bnQgdG9rZW4gd2hlbiBjcmVhdGluZyBhIG5ldyBhY2NvdW50LiBDaGVjayBvdXQgdGhlIHNldHVwQWNjb3VudCBmdW5jdGlvbi4=
   */
